  ...
  var h = {
            ...
            if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
              ...
              (L =
                (I =
                  k -
                  (D =
                    Math.floor(k / e.slidesPerView) - O * e.slidesPerColumn) *
                    e.slidesPerView -
                  O * e.slidesPerView) +
                (D * E) / M),
                $.css({
        ...
        if (
          ...
          for (var _ = 0; _ < p.length; _ += 1) {
            ...
            e.roundLengths && (Z = Math.floor(Z)),
              p[_] < this.virtualSize + p[0] && S.push(Z);
          }
          p = S;
        }
        if (!e.centeredSlides) {
          ...
          for (var Q = 0; Q < p.length; Q += 1) {
            ...
            e.roundLengths && (J = Math.floor(J)),
              p[Q] <= this.virtualSize - s && S.push(J);
          }
          (p = S),
    ...
    updateProgress: function (e) {
      ...
      0 === i
        ...
        n.extend(this, { progress: s, isBeginning: a, isEnd: r }),
        ...
        if (
          ...
          if (!p || !(d <= c || d >= t.screen.width - c)) {
            if (
              ...
              var u = !0;
              s(l.target).is(a.formElements) && (u = !1),
                e.activeElement &&
      ...
      events: {
        attachEvents: function () {
          ...
          (this.onTouchStart = b.bind(this)),
            ...
            t.cssMode && (this.onScroll = E.bind(this)),
